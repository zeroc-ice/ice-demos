...
struct BidirWakeUpService: WakeUpService {
    // Implements the method wakeMeUp from the WakeUpService protocol generated by the Slice compiler.
    func wakeMeUp(timeStamp: Int64, current: Ice.Current) throws {
        ...
        print("Dispatching wakeMeUp request { timeStamp = '\(formattedTime)' }")
