...
class SQLRequestContext
{
    ...
    public static void initialize(com.zeroc.Ice.Logger logger, ConnectionPool pool)
    {
        assert _logger == null;
        assert _pool == null;
    ...
    private static com.zeroc.Ice.Logger _logger = null;
    private static ConnectionPool _pool = null;

    private boolean _trace = true;
    private java.util.List<java.sql.Statement> _statements = new java.util.LinkedList<>();
