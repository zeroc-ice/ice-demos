...
class Server {
    public static void main(String[] args) {
        // Create an Ice communicator. We'll use this communicator to create an object adapter. The communicator gets
        // its configuration properties from the file 'config.server', in the server's current working directory.
