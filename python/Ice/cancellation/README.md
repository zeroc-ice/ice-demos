...
The Cancellation demo shows how to cancel an asynchronous invocation using the future cancel method. It also shows a
related feature: invocation timeouts
