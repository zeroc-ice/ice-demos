...
async def main():
    ...
    # Create an Ice communicator. We'll use this communicator to create an object adapter. We enable asyncio support by
    # passing the current event loop to initialize.
