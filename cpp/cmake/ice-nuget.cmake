...
# Download and configure the Ice NuGet package for Windows.
...
if(NOT EXISTS "${Ice_NUGET_DIR}")
  ...
  execute_process(
    COMMAND "${NUGET_EXE}" install -OutputDirectory "${CMAKE_CURRENT_LIST_DIR}/packages" "${Ice_NUGET_NAME}" -Version "${Ice_NUGET_VERSION}"
