...
main(int argc, char* argv[])
{
    ...
    // Create an Ice communicator to initialize the Ice runtime. The CommunicatorHolder is a RAII helper that
    // destroys the communicator when it goes out of scope.
    ...
    auto adapter = communicator->createObjectAdapterWithEndpoints("GreeterAdapter", "tcp -h \"::0\" -p 4061");
