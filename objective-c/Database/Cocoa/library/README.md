This demo is a Cocoa client for the [Java library demo](../../../../java/Database/library). This application provides a graphical interface to the library server. It permits you to:
