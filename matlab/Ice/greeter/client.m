function client(args)
    %CLIENT A simple Ice client that connects to a Greeter server and sends requests.
    ...
    % If you run the server on a different computer, replace hello.zeroc.com in the string below with the server's
