...
public class MTalkService extends Service implements com.zeroc.mtalk.service.Service
{
    ...
    private class PeerImpl extends MTalk._PeerDisp
    {
        ...
        {
            info = incoming(name, (PeerPrx)peer.ice_fixed(current.con), current.con);
        }

        @Override
        public void message(String text, Ice.Current current)
        {
            received(info, text);
        }
    ...
    //
    private class DiscoveryImpl extends MTalk._DiscoveryDisp
    {
        @Override
        public void announce(String name, MTalk.PeerPrx proxy, Ice.Current current)
        {
    ...
    public void initialize()
    {
        ...
        try
        {
            ...
            //
            _discovery = MTalk.DiscoveryPrxHelper.uncheckedCast(
    ...
    public void connect(String name, String proxy)
    {
        ...
        info.local = MTalk.PeerPrxHelper.uncheckedCast(_adapter.addWithUUID(
            new MTalk._PeerDisp()
            {
                ...
                public void message(String message, Ice.Current current)
                {
    ...
    synchronized private PeerInfo incoming(String name, MTalk.PeerPrx peer, Ice.Connection con)
        throws MTalk.ConnectionException
    {
        //
    ...
    private void configureConnection(final PeerInfo info)
    {
        ...
        //
        info.connection.setCloseCallback(new Ice.CloseCallback()
            {
                @Override
        ...
        info.connection.setACM(new Ice.IntOptional(30), new Ice.Optional<Ice.ACMClose>(Ice.ACMClose.CloseOff),
    ...
    private void checkNetwork()
    {
        ...
        Ice.ObjectAdapter multicastAdapter = null;
                ...
                if(_networkEnabled)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            _local = MTalk.PeerPrxHelper.uncheckedCast(
                            ...
                            _multicastAdapter.add(new DiscoveryImpl(), Ice.Util.stringToIdentity("discover"));
