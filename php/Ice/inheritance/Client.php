...
$rootDir = Inheritance\DirectoryPrxHelper::createProxy($communicator, "RootDir:tcp -h localhost -p 4061");
...
function listRecursive($dir, $depth) {
    ...
    foreach ($contents as $node) {
        ...
        $subdir = Inheritance\DirectoryPrxHelper::checkedCast($node);
        ...
        if ($subdir !== null) {
            ...
            $file = Inheritance\FilePrxHelper::uncheckedCast($node);
            $lines = $file->read();
