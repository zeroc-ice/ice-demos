...
# The Slice module Inheritance maps to a Ruby module with the same name.
...
#
# @param [Inheritance::DirectoryPrx] dir The directory to list.
...
Ice::initialize(ARGV) do |communicator|
    ...
    rootDir = Inheritance::DirectoryPrx.new(communicator, "RootDir:tcp -h localhost -p 4061")
