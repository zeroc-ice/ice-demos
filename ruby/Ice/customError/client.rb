...
Ice::initialize(ARGV) do |communicator|
    ...
    for name in names do
        ...
        begin
            ...
            puts "Failed to create a greeting for '%s': DispatchException { message = '%s', replyStatus = %s }", 
                name, exception.message, replyStatus
        rescue VisitorCenter::GreeterException => exception
            puts "Failed to create a greeting for '%s': GreeterException { errorMessage = '%s', error = %s }",
