...
if(document.location.protocol === "file:")
{
    const setupDialog = "<div id=\"setup-modal\" class=\"reveal-modal\" data-reveal>" +
          ...
          "Ice for JavaScript <a href=\"https://doc.zeroc.com/rel/ice-releases/ice-4-0/ice-4-0-0-release-notes\">" +
...
function checkGenerated(files)
{
    const dialog = "<div id=\"build-required-modal\" class=\"reveal-modal\" data-reveal>" +
          ...
          "<a href=\"https://doc.zeroc.com/rel/ice-releases/ice-4-0/ice-4-0-0-release-notes\">release notes</a> " +
