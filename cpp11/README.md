...
```shell
set PATH=%USERPROFILE%\ice-demos\cpp11\packages\zeroc.ice.v143.3.7.11\build\native\bin\x64\Debug;%USERPROFILE%\ice-demos\cpp11\packages\zeroc.ice.v143.3.7.11\build\native\bin\x64\Release;%PATH%
```
